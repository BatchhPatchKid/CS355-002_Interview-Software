...
$sql = "SELECT question_text, logged_question_id, user_id, class_name, competency_name, class_subject, question_notes, parent_id, date_added FROM logged_questions ORDER BY date_added DESC";
        ...
        <table id="questionsTable">
          ...
          <?php while ($row = $result->fetch_assoc()) { ?>
            <tr data-id="<?=htmlspecialchars($row['logged_question_id'])?>" onclick="selectQuestion(this)">
              ...
              <td><?=htmlspecialchars($row['logged_question_id'])?></td>
...
<script>
  ...
  function saveEdit() {
    ...
    const body = `table=logged_questions&id=${id}` +
